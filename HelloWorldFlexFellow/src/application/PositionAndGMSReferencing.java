...
public class PositionAndGMSReferencing extends RoboticsAPIApplication {
    ...
    private static double joggingVelocity = 0.15;                      // relative velocity
    private static double jointAcceleration = 0.2;
    private static double jointJerk = 0.15;
    ...
    private void performMotion(JointPosition position)
    {
        ...
        PTP mainMotion = new PTP(position).setJointVelocityRel(joggingVelocity).setJointAccelerationRel(jointAcceleration).setJointJerkRel(jointJerk);
        ...
        PTP motion1 = new PTP(position1).setJointVelocityRel(joggingVelocity).setJointAccelerationRel(jointAcceleration).setJointJerkRel(jointJerk);
        ...
        PTP motion2 = new PTP(position2).setJointVelocityRel(joggingVelocity).setJointAccelerationRel(jointAcceleration).setJointJerkRel(jointJerk);
